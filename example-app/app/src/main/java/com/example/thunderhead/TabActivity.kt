...
/**
 * Sample tab view activity used to show optimization
 */
            ...
            for (optimization in response.optimizations) {
                ...
                if (jsonObject.has("actions")) {
                    ...
                    if (action.getString("name").contains("banner")) {
                        viewAdapter.bannerUrl = action.getJSONObject("asset").getString("content")
                        Log.e("url", viewAdapter.bannerUrl)
                        viewAdapter.notifyDataSetChanged()
                    } else if (action.getString("name").contains("card")) {
                        viewAdapter.cardUrl = action.getJSONObject("asset").getString("content")
                        viewAdapter.notifyDataSetChanged()
                    }
                }
            }
